...
1. Press the "Use template" button at the top of this repo to create a new repo with the contents of this optimizely
...
```php
$optimizely = new Astrogoat\Optimizely();
echo $optimizely->echoPhrase('Hello, Astrogoat!');
```
